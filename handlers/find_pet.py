...
@router.callback_query(StateFilter(None), NavigationButtonCallback.filter())
async def navigation_button(query: CallbackQuery, state: FSMContext, callback_data: PetTypeCallback):
